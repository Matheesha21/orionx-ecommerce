...
export function AdminDashboardPage() {
  ...
  const totalCustomers = useMemo(() => {
    return new Set(orders.map((order) => order.user?.email).filter(Boolean)).size;
  }, [orders]);
                          ...
                          <div className="flex flex-wrap justify-center gap-2">
                            {!order.isPaid && (
                              <button
                                ...
                                className="px-2 py-1 text-xs bg-blue-500/10 text-blue-400 rounded disabled:opacity-50 disabled:cursor-not-allowed"
                              >
                            ...
                            {!order.isDelivered && (
                              <button
                                ...
                                className="px-2 py-1 text-xs bg-green-500/10 text-green-400 rounded disabled:opacity-50 disabled:cursor-not-allowed"
                              >
