...
export function CheckoutPage() {
  ...
  const { items, subtotal, discount, tax, shipping, total, clearCart } =
  useCart();
  ...
  const handlePlaceOrder = () => {
    const newOrderNumber = `ORX-${Date.now().toString(36).toUpperCase()}`;
        ...
        <div className="mb-12">
            ...
            <Fragment key={step.id}>
                  <div className="flex items-center">
                    <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-colors ${index <= stepIndex ? 'bg-primary border-primary text-white' : 'border-border text-text-muted'}`}>
                  ...
                  <step.icon className="w-5 h-5" />
                    ...
                    <span
                  className={`ml-3 text-sm font-medium hidden sm:block ${index <= stepIndex ? 'text-text-primary' : 'text-text-muted'}`}>
              ...
              <div
                className={`flex-1 h-0.5 mx-4 ${index < stepIndex ? 'bg-primary' : 'bg-border'}`} />
                ...
                <form onSubmit={handleShippingSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      onChange={(e) =>
                      updateShipping('zipCode', e.target.value)
                      }
                      className="w-full px-4 py-3 bg-background border border-border rounded-lg text-text-primary focus:outline-none focus:border-primary" />
              ...
              className="bg-surface/50 border border-border rounded-xl p-6">
                ...
                <form onSubmit={handlePaymentSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    onChange={(e) =>
                    updatePayment('cardName', e.target.value)
                    }
                    className="w-full px-4 py-3 bg-background border border-border rounded-lg text-text-primary focus:outline-none focus:border-primary" />
